...
class SignUp extends Connexion
{
	...
	public function register($nom, $password)
	{
		...
		// I have to destroy the session when the user sign up (when he will be redirected to the signIn page if there is already a session he will access to an other user profil)
		session_start();
